...
:::note Design note
Written before the code. Global scope is planned first; the per-project part is specified so it can follow without re-deciding anything. Source: `docs/conceptions/ai-agents.md`.
:::
