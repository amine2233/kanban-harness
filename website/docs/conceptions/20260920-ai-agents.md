---
slug: /conceptions/ai-agents
title: AI agents
---

:::note Design note
Written before the code. Global scope is planned first; the per-project part is specified so it can follow without re-deciding anything. Source: `docs/conceptions/20260920-ai-agents.md`.
:::
...
tools: [] # reserved, see 20260920-mcp-servers.md
---
