---
slug: /conceptions/provider-oauth-hardening
title: Provider OAuth hardening
---

:::note Design note
The three assumptions the shipped OAuth flow was designed against that did not survive contact with the code. Source: `docs/conceptions/20260922-provider-oauth-hardening.md`.
:::
...
[`provider-sign-in.md`](provider-sign-in) decides the flow itself — PKCE, `state`, session
...
secrets ([`ARCHITECTURE.md`](../architecture)), and renewing needs the provider registry and
