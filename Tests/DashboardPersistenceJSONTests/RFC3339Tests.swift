...
struct RFC3339Tests {
    @Test
    func parsesChronoMicrosecondTimestamps() throws {
    ...
    @Test
    func formatThenParseRoundTripsToTheMicrosecond() throws {
