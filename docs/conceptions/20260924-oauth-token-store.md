# The token store: what the dashboard obtains and must keep
...
[`config-secret-references.md`](20260924-config-secret-references.md), and this note does not touch it.
...
[`provider-sign-in.md`](20260921-provider-sign-in.md) § 1 answered that with `credentials.json` at `0600`,
...
opens a database ([`cli-as-source-of-truth.md`](20260923-cli-as-source-of-truth.md) D-1), so there is no
...
without touching the store. See [`provider-sign-in.md`](20260921-provider-sign-in.md) `T-26` and the
...
home lives inside one — see [`config-secret-references.md`](20260924-config-secret-references.md) D-9. A
...
- **API keys** — [`config-secret-references.md`](20260924-config-secret-references.md).
